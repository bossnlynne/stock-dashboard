...
app_html   = (script_dir / 'app.html').read_text('utf-8')
...
ct_with_tag = aesgcm.encrypt(iv, app_html.encode('utf-8'), None)
ct   = ct_with_tag[:-16]
tag  = ct_with_tag[-16:]
...
out = script_dir.parent / 'index.html'
out.write_text(loader, 'utf-8')
kb = len(loader) / 1024
print(f"✅  Generated index.html ({kb:.1f} KB)")
print(f"   Password: 0790")
print(f"   Output:   {out}")
